...
Upravljanje licencama programa Visio može se dovršiti u **centru za administratore sustava Microsoft 365**.
...
- Da biste **kupili ili uklonili** licence programa Visio, otvorite **odjeljak naplata > [proizvoda](https://go.microsoft.com/fwlink/p/?linkid=842054)**. Dodatne informacije potražite u članku [Kupnja i uklanjanje licenci](https://docs.microsoft.com/microsoft-365/commerce/licenses/buy-licenses#buy-or-remove-licenses-for-your-business-subscription).
- Da biste **odustali** od pretplate na Visio, otvorite odjeljak **naplata > [proizvoda](https://go.microsoft.com/fwlink/p/?linkid=842054)**, odaberite pretplatu na Visio, a zatim u odjeljku **postavke pretplate i plaćanja** odaberite **Odustani od pretplate**. Dodatne informacije potražite u članku [Otkazivanje pretplate](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/cancel-your-subscription).
