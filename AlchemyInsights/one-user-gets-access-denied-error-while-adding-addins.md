...
ms.locfileid: "54076121"
---
# <a name="one-user-gets-access-denied-error-while-adding-add-ins-in-outlook"></a>Prilikom dodavanja dodataka u programu Outlook

Korisnička ljuska PowerShell Da biste pronašli dozvole:
