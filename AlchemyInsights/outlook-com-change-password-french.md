...
1. Accédez [https://account.microsoft.com/security](https://go.microsoft.com/fwlink/p/?linkid=842325&amp;clcid=0x409) ŕ et sélectionnez **Sécurité du mot de passe**.
2. Par mesure de sécurité, vous pouvez être invité ŕ confirmer votre identité ŕ l'aide d'un code de sécurité.
3. Entrez votre mot de passe actuel, votre nouveau mot de passe, puis sélectionnez **Enregistrer**.

Si vous avez oublié votre mot de passe, accédez ŕ la [stranica de réinitialisation de mot de passe de compte Microsoft](https://go.microsoft.com/fwlink/p/?linkid=841909), puis suivez les poziva.
