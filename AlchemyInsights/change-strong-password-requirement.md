...
- [Povezivanje sa sustavom Office 365 pomoću komponente PowerShell](https://docs.microsoft.com/office365/enterprise/powershell/connect-to-office-365-powershell#connect-with-the-microsoft-azure-active-directory-module-for-windows-powershell)
...
- [Postavljanje lozinke pojedinačnog korisnika da nikada ne istekne](https://docs.microsoft.com/microsoft-365/admin/add-users/set-password-to-never-expire)
