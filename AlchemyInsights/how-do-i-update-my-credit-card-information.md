...
1. U centru za administratore sustava Microsoft 365 idite na stranicu **Naplata** \> [Načini plaćanja](https://go.microsoft.com/fwlink/p/?linkid=842054).

2. Na stranici **Načini plaćanja** odaberite kreditnu karticu ili bankovni račun da biste ga ažurirali.

3. Da biste promijenili podatke o kreditnoj kartici ili bankovnom računu, odaberite **Uređivanje pojedinosti o plaćanju**.

> [!NOTE]
> Ako je drugi administrator kupio pretplatu, nećete moći ažurirati podatke o kreditnoj kartici ili bankovnom računu. Ako je kreditna kartica pred istekom, a drugi administrator nije u mogućnosti ažurirati podatke, prekid korištenja usluge možete spriječiti dodavanjem druge kreditne kartice ili novog bankovnog računa za tu pretplatu.
