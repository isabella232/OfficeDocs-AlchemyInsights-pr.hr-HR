...
Ste vous recevez du Courrier indésirable, vous pouvež bloquer Les adrese de messagerie et des Domaines que vous ne Voulez pas recevoir des poruke. Ajouter une adresa de messagerie ou un Domaine ŕvotr liste des expă ˇ Dite bloqué pour déplacer cete u porukama directiment veri Voted dosije Courrier indésirable.

1. Accédez **ŕparamètres**  >  **afficher tous les paramètres d ' Outlook**  >  **Courrier indésirable**.
1. Sous **Domaines et expédžiteurs bloqués** sélectionnez **Ajouter**.
