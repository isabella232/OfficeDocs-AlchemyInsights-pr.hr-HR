...
Si vous recevez du courrier indésirable, vous pouvez bloquer les adresses de messagerie et des domaines que vous ne voulez pas recevoir des messages. Ajouter une adresse de messagerie ou un domaine à votre liste des expéditeurs bloqués pour déplacer ces poruke directement vers votre dosje courrier indésirable.

1. Accédez ŕ **Paramètres** > **Afficher tous les paramètres d'Outlook** > **Courrier indésirable**.
