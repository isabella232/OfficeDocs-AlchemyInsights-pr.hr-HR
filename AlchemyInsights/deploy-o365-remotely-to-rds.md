...
- Pomoću jednostavnog popravka TLS 1.2 kao zadano omogućite ako koristite stariju verziju sustava Windows (npr. Windows 7 SP1, Windows Server 2008 R2). Da biste jednostavno ispravili i dodatne informacije, pogledajte ažuriranje da biste [omogućili TLS 1.1 i TLS 1.2](https://support.microsoft.com/en-us/topic/update-to-enable-tls-1-1-and-tls-1-2-as-default-secure-protocols-in-winhttp-in-windows-c4bd73d2-31d7-761e-0178-11268bb10392#bkmk_easy)kao zadane sigurne protokole u sustavu WinHTTP u sustavu Windows . 
- Imati plan koji sadrži Microsoft 365 Apps za velike tvrtke (prethodno Office 365 Plus). Primjerice, Office 365 E3 ili Microsoft 365 E5 ili bilo koji plan koji obuhvaća verziju programa Project ili Visio za stolna računala, kao što su Project tarifa 3 ili Visio tarifa 2, ili plan Microsoft 365 Business Premium, koji obuhvaća i Microsoft 365 Apps za male tvrtke.
...
**Napomena:** da biste Microsoft 365 Apps u načinu aktivacije zajedničkog računala, preuzmite i pokrenite [Microsoft pomoćnik za podršku i oporavak](https://docs.microsoft.com/alchemyinsights/deploy-o365-remotely-to-rds). Detalje o preduvjetima, uputama za postavljanje i uputama za prilagodbu instalacija pomoću alata za implementaciju Office potražite u [članku Implementacija Microsoft 365 Apps pomoću](https://docs.microsoft.com/deployoffice/deploy-microsoft-365-apps-remote-desktop-services)servisa udaljene radne površine .
...
- [Ponovno postavljanje Microsoft 365 Apps za velike tvrtke aktivacijskog stanja](https://docs.microsoft.com/office/troubleshoot/activation/reset-office-365-proplus-activation-state)
