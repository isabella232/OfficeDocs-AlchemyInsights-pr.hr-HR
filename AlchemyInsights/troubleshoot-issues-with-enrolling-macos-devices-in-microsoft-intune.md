---
title: Otklanjanje poteškoća s sinkronizacijom macOS uređaja u programu Microsoft Intune
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.date: 04/21/2020
...
ms.locfileid: "47699799"
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Otklanjanje poteškoća s sinkronizacijom macOS uređaja u programu Microsoft Intune
...
3. [Informirajte se o tome kako upisati macOS uređaje u programu Microsoft Intune](https://docs.microsoft.com/intune/macos-enroll).

[Pogledajte priručnik za krajnje korisnike da biste upisali macOS uređaj u programu Microsoft Intune](https://docs.microsoft.com/intune-user-help/enroll-your-device-in-intune-macos-cp)
