...
Za dodatne informacije o vanjskim zajedničko korištenje (Gosti), posjetite veze ispod.
...
- [Upravljanje gostov pristup u grupama za Office 365](https://docs.microsoft.com/office365/admin/create-groups/manage-guest-access-in-groups?view=o365-worldwide)
...
**Primanje pogreške s vanjskog korisnika (gost)?**

Provjerite dolje navedene veze. 

- [Zajedničko korištenje OSE pogreške u Sharepoint ili OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
