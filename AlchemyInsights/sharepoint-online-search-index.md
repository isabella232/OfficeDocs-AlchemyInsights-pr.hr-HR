...
>[! Važno!]: Ako web-mjesto, dokument (biblioteka) ili popis je izbrisana i još uvijek prikazuje u rezultatima pretraživanja, korisnici trebaju primati pojavila **Pogreška 404 datoteka nije pronađena** prilikom pokušaja pristupa. Taj problem treba prijavljeni kao slučaj podršku za daljnje istraživanja. 
