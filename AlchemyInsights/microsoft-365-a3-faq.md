...
- Da **biste ponovno aktivirali** pretplatu na A3, pogledajte [ponovnu aktivaciju pretplate](https://docs.microsoft.com/alchemyinsights/reactivate-your-subscription).
- Da biste  **produljili** probnu verziju A3, pogledajte [proširivanje probne verzije](https://docs.microsoft.com/microsoft-365/commerce/extend-your-trial).
