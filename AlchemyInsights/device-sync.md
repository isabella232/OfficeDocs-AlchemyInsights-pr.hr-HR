...
ms.locfileid: "54031110"
---
# <a name="device-sync"></a>Sinkronizacija uređaja

**Ako sinkronizacija uređaja ne funkcionira, sjećate se sljedećih točaka:**

- Objekt uređaja bit će vidljiv na portalu Azure tek nakon registracije uređaja.
- Ako želite da se uređaj pridruži lokalnoj domeni i na servisu Azure, npr. hibridnom pridruživanju, detalje potražite u vezama u nastavku:
