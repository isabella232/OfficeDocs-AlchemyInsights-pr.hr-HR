...
Dodatne informacije o stvaranju web-mjesto koncentratora iz nove Admin Center ili Microsoft PowerShell potražite [Stvori web-mjesto koncentratora u SharePoint Online](https://docs.microsoft.com/sharepoint/create-hub-site) . 
...
Dodatne informacije o tome kako ukloniti postojeće web-mjesto koncentratora iz nove Admin centar ili PowerShell pogledajte [uklonili web-mjesto koncentratora](https://docs.microsoft.com/sharepoint/remove-hub-site) . 
