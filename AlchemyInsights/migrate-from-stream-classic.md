...
Dodatne informacije o migraciju iz klasičnog strujanja u novi tok potražite u članku Migracija iz programa [Microsoft Stream (klasično) na novi Microsoft Stream](https://docs.microsoft.com/stream/classic-migration)