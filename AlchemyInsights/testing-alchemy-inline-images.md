---
title: Testiranje slika u istoj razini
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669384"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="456d0-102">Pristup stranici domene</span><span class="sxs-lookup"><span data-stu-id="456d0-102">Access the Domains Page</span></span>

<span data-ttu-id="456d0-103">Da biste pristupili stranici domene, samo kliknite ovu ikonu u nastavku:</span><span class="sxs-lookup"><span data-stu-id="456d0-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="456d0-104">Zatim možete dodati, izmijeniti ili ukloniti domenu.</span><span class="sxs-lookup"><span data-stu-id="456d0-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="456d0-105">Dodatne informacije potražite u članku [Najčešća pitanja o domenama.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="456d0-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
