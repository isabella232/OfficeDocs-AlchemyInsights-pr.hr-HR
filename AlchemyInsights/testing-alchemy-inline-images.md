---
title: Testiranje inline slika alkemije
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "43759972"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d6ad4-102">Pristup stranici domene</span><span class="sxs-lookup"><span data-stu-id="d6ad4-102">Access the Domains Page</span></span>

<span data-ttu-id="d6ad4-103">To pristup domena stranica, pravedan klik ovaj ikona ispod:</span><span class="sxs-lookup"><span data-stu-id="d6ad4-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d6ad4-104">Zatim možete dodati, izmijeniti ili ukloniti domenu.</span><span class="sxs-lookup"><span data-stu-id="d6ad4-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d6ad4-105">Dodatne informacije potražite u [najčešćim pitanjima o domenama.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d6ad4-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
