...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="36f45-102">Pristup stranici domena</span><span class="sxs-lookup"><span data-stu-id="36f45-102">Access the Domains Page</span></span>

<span data-ttu-id="36f45-103">Za pristup stranici domena, samo kliknite ovu ikonu ispod:</span><span class="sxs-lookup"><span data-stu-id="36f45-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="36f45-104">Zatim možete dodavati, mijenjati ili ukloniti vaše domene.</span><span class="sxs-lookup"><span data-stu-id="36f45-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="36f45-105">Dodatne informacije potražite na [Najčešća pitanja vezana uz domenama.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="36f45-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
