...
---
# <a name="cancel-visio-subscription"></a>Otkazivanje pretplate na visio

Administratori mogu otkazati pretplatu na visio za svoju tvrtku ili ustanovu u centru za administratore sustava Microsoft 365.

1. Idite na stranicu **naplata** \> [proizvoda](https://go.microsoft.com/fwlink/p/?linkid=842054) .
2. Na kartici **proizvodi** Pronađite pretplatu na visio koju želite otkazati. Odaberite **Dodatne akcije** (tri točkice), a zatim **poništite pretplatu**.
