...
3. Odaberite **Dodatne akcije** (tri točke), a zatim **ponovno aktiviraj ovu pretplatu.**
    > [!IMPORTANT]
    > Ako ne vidite ponovnu **aktivaciju pretplate kao dostupne** akcije, nazovite podršku [da](/microsoft-365/admin/contact-support-for-business-products) biste ponovno aktivirali pretplatu.
